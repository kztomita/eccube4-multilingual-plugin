...
trait ClassCategoryTrait
{
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="Plugin\MultiLingual\Entity\LocaleClassCategory", mappedBy="ClassCategory", cascade={"persist","remove"})
     * @ORM\OrderBy({"id" = "ASC"})
     *
     */
    private $Locales;
    ...
    {
        return LocaleClassCategory::class;
    }
